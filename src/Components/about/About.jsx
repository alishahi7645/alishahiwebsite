...
function About() {
  return (
    <div className="about w-full h-full flex align-center justify-center">
      <div className="container w-full p-10">
        <h1 className="text-3xl mx-auto text-center">درباره من</h1>
        <div className="about-items  flex-row md:flex align-center justify-between w-full">
          <div className="about-r mt-10 w-full md:w-1/2 p-2">
            ...
            <p className="text-gray-700 mt-5 text-lg text-justify">
            ...
            <div className="about-fact w-full flex mt-5 align-center justify-between">
              <div className="w-1/3 text-center">
                ...
                <span className="text-gray-700">پروژه های انجام شده</span>
              </div>
              <div className="w-1/3 text-center">
                <p className="text-3xl font-bold">28</p>
                <span className="text-gray-700">مشتریان راضی</span>
              </div>
              <div className="w-1/3 text-center">
                <p className="text-3xl font-bold">98</p>
                <span className="text-gray-700">عملکرد مثبت</span>
              </div>
            </div>
          ...
          <div className="about-l w-full md:w-1/2 mt-10 p-2">
            <div className="progress-title w-full mb-4">
              <h3 className="text-lg mb-1">Html</h3>
              <div className="w-full bg-gray-300 h-2 rounded-full">
                <div className="bg-red-500 h-2 rounded-full w-[95%]"></div>
              </div>
            </div>
            <div className="progress-title w-full mb-4">
              <h3 className="text-lg mb-1">Css</h3>
              <div className="w-full bg-gray-300 h-2 rounded-full">
            ...
            <div className="progress-title w-full mb-4">
              <h3 className="text-lg mb-1">JavaScript</h3>
              <div className="w-full bg-gray-300 h-2 rounded-full">
                <div className="bg-red-500 h-2 rounded-full w-[55%]"></div>
              </div>
            </div>
            <div className="progress-title w-full mb-4">
              <h3 className="text-lg mb-1">React Js</h3>
              <div className="w-full bg-gray-300 h-2 rounded-full">
                <div className="bg-red-500 h-2 rounded-full w-[65%]"></div>
              </div>
            </div>
