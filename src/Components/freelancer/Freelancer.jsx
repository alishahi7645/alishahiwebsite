    ...
    <div className="freelancer py-5 px-5 w-full bg-red-500 dark:bg-gray-700">
        <div className="container p-5">
            <div className="freelancer-title p-5 text-center">
                ...
                <a href="https://t.me/alishahi_sh" className='border py-2 text-lg rounded px-4 text-white mt-3 transition-all hover:bg-white hover:text-black'>کارتو به من بسپار</a>
            </div>
        </div>
    </div>
  )
